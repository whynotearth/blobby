<template>
  <div
    ...
    v-if="openModal"
  >
    <div class="bg-white shadow-24dp p-4 rounded-lg">
      <div v-if="key === 'ask-user-permission'">
        <h6>
          Foodouken uses your location to get your <br />
          favorite dishes straight to you.
        </h6>
        <div class="mt-8 flex justify-end space-x-2 text-white">
          <button class="bg-red-600 p-2 rounded-md" @click="onCancel">
            Cancel
          </button>
          <button class="bg-green-600 p-2 rounded-md" @click="getLocation">
            Allow
          </button>
        </div>
      </div>
